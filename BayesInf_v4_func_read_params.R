...
Prob_Distr_Params[[2]] = ppois(c(0:(population-1)), lambda=10, log = FALSE)
...
ratio_orig_mean_deg = 1 #1 means the same, .5 is half the mean degree reported, 2 twice the mean degree reported
