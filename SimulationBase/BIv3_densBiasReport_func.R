dens_biased_sim <- function(init_seed, num_samples, biaspct) {
  outfile = paste("dens_biasReport", round(biaspct*100), "__n", num_samples, "_", init_seed, ".RData", sep = "")
  ...
  target_dens = (mean(deg_new)/2)/(population-1)
